(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon_menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon_menu")) {
                bodyLockToggle();
    ...
    class popup_buy_Popup {
        constructor(options) {
            let config = {
                ...
                classes: {
                    popup: "popup-buy",
                    popupContent: "popup__content-buy",
                    popupActive: "popup_show",
                    bodyActive: "popup-show"
                },
                focusCatch: true,
    ...
    flsModules.popup = new popup_buy_Popup({});
    ...
    let formValidate = {
        ...
        validateInput(formRequiredItem) {
            ...
            if (formRequiredItem.dataset.required === "email") {
                ...
                formRequiredItem.value = formRequiredItem.value.replace(" ", "");
                if (formRequiredItem.value.length !== 16) {
                    this.addError(formRequiredItem);
                    error++;
                } else this.removeError(formRequiredItem);
            } else if (formRequiredItem.dataset.required === "phone") {
                formRequiredItem.value = formRequiredItem.value.replace(" ", "");
                if (formRequiredItem.value.length !== 9) {
                    this.addError(formRequiredItem);
                    error++;
                } else this.removeError(formRequiredItem);
            } else if (formRequiredItem.dataset.required === "name" || formRequiredItem.dataset.required === "surname") if (formRequiredItem.value === "") {
                this.addError(formRequiredItem);
                error++;
    ...
    function initSliders() {
        if (document.querySelector(".products__slider.swiper")) new swiper_core_Swiper(".products__slider.swiper", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".review__slider.swiper")) new swiper_core_Swiper(".review__slider.swiper", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
